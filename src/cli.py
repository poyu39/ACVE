...
if __name__ == '__main__':
    ...
    videos = [os.path.join(file) for file in os.listdir(input_path) if file.split('.')[1] == 'mkv']
    ...
    for video in videos:
        ...
        ass = Ass(ass_path)
        ass.format_events()
        dialogue_audios_path = acve.split_audio_by_dialogue(f'{output_path}/vocals.wav', ass.get_dialogues('TEXT-JP'))
